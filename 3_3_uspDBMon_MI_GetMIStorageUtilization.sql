...
DROP PROCEDURE IF EXISTS [dbo].[uspDBMon_MI_GetMIStorageUtilization]
GO

CREATE PROCEDURE [dbo].[uspDBMon_MI_GetMIStorageUtilization]
AS
	/*
...
VALUES ('uspDBMon_MI_GetMIStorageUtilization', '1.0 GSTGU', NULL, GETDATE(), SUSER_SNAME())
GO

EXEC sp_addextendedproperty 
	@name = 'Version', @value = '1.0 GSTGU', 
	@level0type = 'SCHEMA', @level0name = 'dbo', 
	@level1type = 'PROCEDURE', @level1name = 'uspDBMon_MI_GetMIStorageUtilization'
GO
